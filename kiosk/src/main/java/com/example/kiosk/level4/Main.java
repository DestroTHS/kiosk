...
import com.example.kiosk.level5.Kiosk;
import com.example.kiosk.level5.Menu;
...
public class Main {
    public static void main(String[] args) {
        // 'Burgers' 메뉴 생성
        com.example.kiosk.level5.Menu burgersMenu = new com.example.kiosk.level5.Menu("Burgers");
        // 버거 메뉴 항목 추가
        ...
        // 'Drinks' 메뉴 생성
        com.example.kiosk.level5.Menu drinksMenu = new com.example.kiosk.level5.Menu("Drinks");
        // 음료 메뉴 항목 추가
        ...
        // 'Desserts' 메뉴 생성
        com.example.kiosk.level5.Menu dessertsMenu = new com.example.kiosk.level5.Menu("Desserts");
        // 디저트 메뉴 항목 추가
        ...
        com.example.kiosk.level5.Kiosk kiosk = new Kiosk(menus);
        // 키오스크 프로그램 실행
        kiosk.start();
    }
}
